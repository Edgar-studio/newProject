...
const KTutorial = () => {
    ...
    return (
        <div className="w-full min-h-screen flex flex-col items-center justify-center bg-gray-100 dark:bg-gray-900 p-6">
            <h1 className="text-3xl font-bold mb-6 text-purple-700 dark:text-purple-300">Karate Tutorials</h1>
            <ul className="w-full grid grid-cols-[repeat(4,300px)] grid-rows-[300px,repeat(auto-fit,300px)] gap-8 justify-center">
                {karate.length === 0 ? (
                    <p className="text-gray-500 dark:text-gray-400 text-center col-span-4">No tutorials found.</p>
                ) : (
